    ...
    <section id="slider-store" class="carousel slide" data-ride="carousel" style="padding: 0;">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="./assets/img/img1.jpg" alt="model1">
                <div class="carousel-caption">
                Nicole lee
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/img2.jpg" alt="modelo2">
                <div class="carousel-caption">
                Nicole lee
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/img3.jpg" alt="modelo3">
                <div class="carousel-caption">
                Nicole lee
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:5%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrate como cliente de <span class="tittles-pages-logo">Nicole lee</span> en un sencillo formulario para poder completar tus pedidos</p>
                        <p><a href="registration.php" class="btn btn-info btn-raised btn-block">Registrarse</a></p>   
                   </article>
                </div>

                <div class="col-xs-12 col-sm-6">
                    <img src="assets/img/tv.jpg" alt="Cliente" class="img-responsive" style="width: 70%; display: block; margin: 0 auto;">
                </div>
            </div>
        </div>
    </section>
