    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>REGISTRO <small class="tittles-pages-logo">Nicole lee</small></h1>
            </div>
            <p class="lead text-center">
            ¡Bienvenido a nuestra comunidad! Da vida a tu experiencia personalizando tu cuenta. Completa los detalles a continuación y descubre un mundo de posibilidades esperándote.
            </p>
            <div class="row">
                <div class="col-sm-5 text-center">
                    <figure>
                      <img src="./assets/img/Cliente.jpeg" alt="Cliente" class="img-responsive">
                    </figure>
                </div>
                <div class="col-sm-7">
